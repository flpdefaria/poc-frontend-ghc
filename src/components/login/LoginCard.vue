  ...
  <Card class="w-full max-w-[420px] mx-auto login-card">
    <template #title>
      <div class="flex flex-col gap-1.5">
        <h2 class="text-2xl font-bold tracking-tight text-primary-700 m-0">Sign in</h2>
    ...
    <template #content>
      <form class="mt-5 flex flex-col gap-7" @submit.prevent="onSubmit">
        ...
        <div class="flex items-center justify-between gap-4 -mt-1">
          <label class="inline-flex items-center gap-2 text-sm text-surface-500 cursor-pointer select-none">
          ...
          <Button
            ...
            variant="link"
            size="small"
            class="p-0 text-primary-500 hover:text-primary-600 font-medium"
            severity="secondary"
...
.login-card :deep(.p-password-toggle-mask-icon) {
  color: var(--p-surface-400);
  transition: color 0.15s ease;
}

.login-card :deep(.p-password-toggle-mask-icon:hover) {
...
.login-card :deep(.p-inputtext:focus) {
  border-color: var(--p-primary-400);
  background: var(--p-surface-0);
}

.login-card :deep(.p-floatlabel label) {
  color: var(--p-surface-400);
  background: transparent !important;
  padding: 0;
}

.login-card :deep(.p-floatlabel input:focus ~ label),
.login-card :deep(.p-floatlabel input.p-filled ~ label) {
  background: transparent !important;
...
.login-card :deep(.p-button:not(.p-button-link):not(.p-button-outlined):not(:disabled):hover) {
  transform: translateY(-2px);
  box-shadow: 0 8px 24px color-mix(in srgb, var(--p-primary-500) 45%, transparent);
}

.login-card :deep(.p-button:not(.p-button-link):not(.p-button-outlined):not(:disabled):active) {
  transform: translateY(0);
  box-shadow: 0 2px 8px color-mix(in srgb, var(--p-primary-500) 30%, transparent);
}

.login-card :deep(.p-button-outlined:not(:disabled):hover) {
  transform: translateY(-2px);
...
.login-card :deep(.p-button-outlined:not(:disabled):active) {
  transform: translateY(0);
  box-shadow: none;
}

.login-card :deep(.p-inputtext.p-invalid) {
  border-color: var(--p-red-400) !important;
}

.login-card :deep(.p-checkbox .p-checkbox-box) {
  background: var(--p-surface-0);
...
.login-card :deep(.p-checkbox:not(.p-disabled):hover .p-checkbox-box) {
  background: var(--p-surface-0);
  border-color: var(--p-primary-500);
}

.login-card :deep(.p-checkbox.p-checkbox-checked .p-checkbox-box),
.login-card :deep(.p-checkbox.p-checkbox-checked:hover .p-checkbox-box),
.login-card :deep(.p-checkbox.p-checkbox-checked.p-focus .p-checkbox-box) {
  background: var(--p-surface-0) !important;
  border-color: var(--p-primary-500) !important;
}

.login-card :deep(.p-checkbox.p-checkbox-checked .p-checkbox-icon),
.login-card :deep(.p-checkbox.p-checkbox-checked:hover .p-checkbox-icon),
.login-card :deep(.p-checkbox.p-checkbox-checked.p-focus .p-checkbox-icon) {
